...
interface MyStore {
  ...
  editSurvey: (payload: any, id: undefined | number | string) => Promise<void>;
    ...
    <section className="lg:px-8 sm:px-6 px-4 lg:py-6 py-6">
      <div className="flex flex-row items-center justify-end gap-5">
        ...
        <div
          ...
          className="cursor-pointer bg-red-400 text-white py-[0.4rem] px-4 rounded-md"
        >
          Delete
        </div>
      </div>
      ...
      {loading ? (
        ...
        <form onSubmit={submitHandler} className="lg:w-4/5 w-5/5 mx-auto">
          <div className="flex lg:flex-row flex-col lg:items-center lg:justify-between gap-3">
            <h1 className="mt-6 mb-4 lg:text-2xl text-2xl font-bold">
              Edit Survey Form
            </h1>
          </div>
          ...
          <input
            ...
            className="mt-1 block w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-[#0B1120] focus:ring-2"
          />
          <>
